...
function UniqueManifestationPortalContent() {
  ...
  // DOĞRUDAN LEMON SQUEEZY'YE BAĞLANAN İSTEMCİ FONKSİYONU
  const handleCheckout = async () => {
    try {
      ...
      // Not: Eğer client tarafında API anahtarı gizli kalsın istiyorsan Lemon Squeezy'nin
      // direkt 'Buy Now' form linkini (overlay/redirect) de kullanabilirsin.
      // Ancak doğrudan API üzerinden checkout URL'i almak için public değişkenler gerekir.
      ...
      alert("Ödeme oturumu oluşturulurken bir hata oluştu. Lütfen Vercel Environment Variables kısmına NEXT_PUBLIC_ önekli değişkenleri eklediğinizden emin olun.");
